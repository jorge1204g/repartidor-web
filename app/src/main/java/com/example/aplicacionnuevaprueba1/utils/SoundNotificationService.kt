...
/**
 * Servicio de notificación de sonido para pedidos nuevos
 */
object SoundNotificationService {
    ...
    fun playNewOrderSound(context: Context) {
        try {
            ...
            val soundUri = try {
                Uri.parse("android.resource://${context.packageName}/${com.example.aplicacionnuevaprueba1.R.raw.new_order_notification}")
            } catch (e: Exception) {
